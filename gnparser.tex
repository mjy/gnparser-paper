...
\begin{abstract} % abstract
  ...
  opportunities for science. Variations in spellings of scientific names
  creates a barrier to such linking. Breaking names into semantic elements is
  a necessary step to alleviate this problem.
  \parttitle{Results}
...
Since then GBIF \textit{name-parser} \cite{gbifNameParser}, \texit{YASMEEN}
