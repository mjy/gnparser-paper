...
spellings of name-strings \cite{Patterson2016}. In order to improve this
...
Table~\ref{table:carex} refer to the same taxon. They do so by ``parsing'' the
name-strings into elements (genus name, species name, authors, ranks etc.) and
mentally discarding less significant elements such as annotations and
...
and portability. We limited this version to work with scientific names that
...
\begin{lstlisting}[language=json]
{
  ...
  "details": [ {
    ...
    "specific_epithet": {
      "value": "scirpoidea",
      "authorship": {
        "value": "Michx.", "basionym_authorship": { "authors": [ "Michx." ] }
      }
    },
