...
\begin{abstract} % abstract
  ...
  Parsing Expression Grammar algorithm. The parser deals with straightforward
  and complex scientific name-strings for organisms. It assigns semantic
  meaning to all elements within a scientific name-string (such as ranks, years
  of publication, names of authors, annotations, etc.). Global Names Parser is
  written in Scala, a Java Virtual Machine language. It performs with $\approx
  99\%$ accuracy. It manages 21.4 million name-strings/hour per CPU (73.4
  ...
  line application, socket server, webb-app or RESTful http-service. It is
