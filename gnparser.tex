...
\begin{abstract} % abstract
  % Dima comment: I feel abstract is too long, but dont see how to shorten it
...
\marginpar{Dima:\\ Trying to rewrite \textbf{Background} accoring to
\\http://bit.ly/1rIy9F7} Biology is entering a ``Big Data'' age, where global
...
\marginpar{Dima:\\Paddy and I decided we need to say why separate
package for parser is important. Still writing thisi part...}
